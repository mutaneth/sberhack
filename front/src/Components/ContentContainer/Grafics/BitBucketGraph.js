...
import {VictoryChart,  VictoryGroup, VictoryArea, VictoryTheme, VictoryPolarAxis, VictoryLabel} from 'victory';
...
export default class BitBucketGraph extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <div className={'ContentContainer-StatisticBar-Graph'}>
            <VictoryChart polar
